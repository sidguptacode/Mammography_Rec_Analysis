...
```{r, mamograms_by_state, fig.width=20, fig.height=20, message=FALSE, warning = FALSE} 
plot_df_group(brfss_data, "state", function(df) {single_df_barplot(df, "age", "Age", "Count", paste("Mammography count ", df$state[1], sep=" "), 32)})
```


```{r, mamograms_by_insurance, fig.width=20, fig.height=10, message=FALSE, warning = FALSE}  
