...
```{r, mamogram_rate, fig.align='center', message=FALSE, warning = FALSE}
...
```{r, breast_cancer_deaths, replicate Figure5, message=FALSE, warning = FALSE}
