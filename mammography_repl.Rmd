...
brfss_data |> ggplot(aes(x = age)) |> geom_point()
...
beps |> ggplot(mapping = aes(x = age, fill = vote)) + geom_bar() + theme_minimal() + labs(
fill = "Voted for", x = "Age of respondent", y = "Number of respondents")
```
